...
UI.prototype.deleteContact = function (target) {
    const ui = new UI();
    // bắt event click cho class delete
    // bắt event delete cho all các class delete
...
UI.prototype.showAlert = function (getMsg, getClass) {
    ...
    // Add Text, thêm thông báo text vào trong thẻ div
...
UI.prototype.searchName = function (text) {
    ...
    rows.forEach(function (row) { // chạy hết all dữ liệu
